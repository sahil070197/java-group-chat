    ...
    public void actionPerformed(ActionEvent a) {
        ...
        else if (a.getSource() == signin) 
        {
            try
            {
                ...
                con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system", "garg");
        ...
        if (a.getSource() == signup) {
            try {
                ...
                /*int len=temp.length();
                 ...
                 {*/
                DriverManager.registerDriver(new oracle.jdbc.OracleDriver());
                c = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system", "garg");
                s = c.createStatement();
                connection = true;
